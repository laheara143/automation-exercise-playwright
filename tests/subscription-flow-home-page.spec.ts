...
test('Verify User can succesfuly subscribe to the newsletter in the footer of the Homepage', async ({page}) =>{
    ...
    await page.screenshot ({ path: 'verify-subscription-home-page.png' });
});